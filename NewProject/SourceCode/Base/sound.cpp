...
{
	{ L"Resource/Sound/title.wav", -1 },		//SOUND_BGM_TITLE
	{ L"Resource/Sound/game.wav", -1 },			//SOUND_BGM_GAME
	{ L"Resource/Sound/gameover.wav", -1 },		//SOUND_BGM_GAME_OVER
	{ L"Resource/Sound/gameclear.wav", -1 },	//SOUND_BGM_GAME_CLEAR
	{ L"Resource/Sound/click.wav", 0 },			//SOUND_SE_CLICK
	{ L"Resource/Sound/get.wav", 0 },			//SOUND_SE_GET
	{ L"Resource/Sound/break.wav", 0 },			//SOUND_SE_BREAK
	{ L"Resource/Sound/failure.wav", 0 }		//SOUND_SE_FAILURE
};
...
HRESULT InitSound(HWND hWnd)
{
	...
	for (int nCntSound = 0; nCntSound < SOUND_LABEL_MAX; nCntSound++)
	{
		...
		// サウンドデータファイルの生成
		hFile = CreateFile(g_aParam[nCntSound].fileName, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0, NULL);
